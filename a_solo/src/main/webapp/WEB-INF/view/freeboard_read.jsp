...
<!-- 댓글 삭제 폼 -->
	 ...
	 <form method=post action='./delete_comment2.do'>	 
	 암호 <input type=password name=password size=5>
...
<!-- 댓글쓰기 -->
<form id='comment' action='./bbs_comment2.do' method='post'>
<div style='text-align:center'>
<table width='100%'>
	<tr><td align=center>
	<textarea id="read_contents" name='contents' cols='80' rows='5' onFocus='edit()'>
	
	</textarea>
	</td></tr>
	<tr><td id = "read_table" align=right>
	...
	<input type='hidden' name='num' value='-${article.num}'>
			   ...
			   <c:otherwise>
                     ...
                     function myFunction3() {
 				        location.href="./bbs_list_free.do";
 				}
					function myFunction() {
					        location.href="./bbs_modify2.do";
					}
					function myFunction2() {
				        location.href="./bbs_delete2.do";
				}
